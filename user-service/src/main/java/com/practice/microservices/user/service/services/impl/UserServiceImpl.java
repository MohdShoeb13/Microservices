...
import com.practice.microservices.user.service.entities.Hotel;
import com.practice.microservices.user.service.entities.Rating;
...
import com.practice.microservices.user.service.external.services.HotelService;
...
public class UserServiceImpl implements UserService {
    ...
    public User getUser(String userId) {
        ...
        List<Rating> ratings = Arrays.asList(ratingsOfUser).stream().collect(Collectors.toList());
